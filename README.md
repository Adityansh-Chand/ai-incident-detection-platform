...
describing the world. This service watches its **anomaly score** — whether the telemetry still looks like the healthy traffic the detector was fitted on — and reports
...
numeric PSI over the score distribution on normal training traffic. Population Stability Index, read against the conventional thresholds:
